...
export default function SignUpComponent() {
  ...
  return (
    <>
      ...
      >
        <div className=" h-screen flex justify-center items-center bg-custom-image bg-cover bg-center">
          <div className="m-8">
            <div className="bg-gray-100 p-8 rounded-md shadow-md">
              <div className="relative flex flex-col items-center text-gray-700 bg-transparent shadow-none rounded-xl bg-clip-border">
                ...
                <div class="block  text-2xl antialiased font-regular leading-snug tracking-normal text-blue-gray-900">
                  Sign Up
                </div>
                <form class="max-w-screen-lg mt-8 mb-2 w-80 sm:w-96">
                  ...
                  <div class="inline-flex items-center">
                    ...
                    <label
                      ...
                      htmlFor="remember"
                    >
                      <p class="flex items-center  text-sm antialiased font-semibold leading-normal text-gray-700">
                        I agree
                        <a
                          href="#"
                  ...
                  {isAgreed && (
                    <button
                      class="mt-6 block w-full select-none rounded-lg bg-gray-900 py-3 px-6 text-center align-middle  text-xs font-bold uppercase text-white shadow-md shadow-gray-900/10 transition-all hover:shadow-lg hover:shadow-gray-900/20 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                      type="button"
                  ...
                  {!isAgreed && (
                    <button
                      class="mt-6 block w-full select-none rounded-lg bg-gray-300 py-3 px-6 text-center align-middle  text-xs font-bold uppercase text-white shadow-md shadow-gray-900/10 transition-all focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none hover:cursor-default"
                      type="button"
                    >
                      sign up
                    </button>
                  ...
                  <p class="block mt-4  text-base antialiased font-normal leading-relaxed text-center text-gray-700">
                    ...
                    <a
                      ...
                      class="font-semibold hover:underline hover:cursor-pointer text-gray-900 pl-2"
                    >
                      Sign In
                    </a>
                  </p>
